...
tap.test("url/parse - basic", ({ end, same }) => {
...
tap.test("url/parse - hosts", ({ end, same }) => {
	const hosts = [
		"example.com",
		"www.example.com",
		"travel.travel",
...
tap.test("url/parse - paths", ({ end, same }) => {
	const paths = [
		"/",
		"/bar",
		"/bar/",
...
tap.test("url/parse - query", ({ end, same }) => {
	const queries = [
		"foo[]=bar&foo[]=foo",
